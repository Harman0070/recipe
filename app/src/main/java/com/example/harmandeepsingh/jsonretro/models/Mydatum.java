...
public class Mydatum {
     ...
     */
    public Mydatum(String precipeId, String userId, String precipeName, String precipeImage, String precipeParentId, String precipeDetail, String precipeVideoId) {
        super();
    ...
    public void setResponseUserId(String userId) {
        this.userId = userId;
    }
